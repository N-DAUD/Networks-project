...
print ("The Socket has been generated")

# Fill in start.
tcpSerProt = 8888
tcpSerSock.bind(('', tcpSerProt))
print ("socket is with  %s" %(tcpSerProt))
 
tcpSerSock.listen(5)
print ("socket listening mode")  
# Fill in end.
...
while 1:
  ...
  print ('The connection has arrived by:', addr)
